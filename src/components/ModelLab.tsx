...
> = {
  ...
  career: {
    ...
    evaluation: [
      ...
      { label: 'Prospect career runway', status: 'Projected MLB debut age shapes Career Outlook while Prospect Rank remains a separate near-term signal', measured: true },
  ...
  return (
    <main className="workspace-page model-lab">
      ...
      <section className="model-verdict" aria-label="Current model verdict">
        ...
        <p>The prospect impact model identifies candidates well in historical tests, but tiny samples can distort its highest ranks. Career Outlook therefore stays separate from Prospect Rank, and thin-sample ranks are marked as early estimates instead of full-model results. The full career model still misses too many rare Hall-level endings.</p>
      </section>
