# HarryKnowsBall Source Attestation

## Attestation

On 2026-07-16, the project owner confirmed that Baseball Oracle has permission
to retrieve HarryKnowsBall rankings, movement, attention, and player identity
data for this project.

The attested scope covers:

- automated retrieval from HarryKnowsBall;
...
HarryKnowsBall data is an external dynasty-market comparison signal. It is kept
...
HarryKnowsBall-to-MLBAM mappings may be accepted only when a HarryKnowsBall
player page explicitly publishes the MLBAM identifier. Player names, teams,
ages, and positions are diagnostic fields and must never be used as identity
keys.
